...
const project1 = {
    ...
    caption: `
        Cards do Painel Geral, com gráficos da Chart.js, abas do Bootstrap e seletores de período 
        da Day.js.
    `,
    image: mainImage,
    intro: `
        O VC-X Sonar é uma plataforma que visa descomplicar a automação, aquisição e gestão de 
        telecom e TI para empresas, gerando visão, controle e economia. O projeto do novo painel 
        geral do software tem como objetivo expor de maneira simplificada e interativa informações 
        úteis sobre consumo, custos e recursos de Telecom e TI dos clientes. Meu papel foi de 
    ...
    steps: [
                    ...
                    <blockquote className="blockquote px-5 mb-0">
                        <p className="my-4">
                            <em>
                                ...
                                interpretado como um painel geral, fazendo com que só sejam 
                                vistas informações de um módulo e “escondendo” as informações 
                                dos outros módulos. Foi relatado inclusive que clientes 
                                comentaram que não tinham percebido a existência dos outros 
                                painéis.
                            </em>
                        </p>
                        <p>
                            <em>
                                Outro ponto levantado por clientes internos foi que atualmente 
                                os painéis apresentam informações em períodos de tempo curto 
                                (por mês). Por consequência há uma dificuldade de enxergar 
                                dados de períodos mais longos e fazer comparações entre 
                                períodos (ex: diferenças entre os meses ao longo de um ano).
                            </em>
                        </p>
            ...
            content: (
                <>
                    ...
                    <p className="mt-4 mb-0">
                        Entrevistados: Rodrigo Bedete (Head de Soluções), Marina Turrisi 
                        (Analista de Sucesso do Cliente), João Plentz (Chief Operating Officer) 
                        e Alexandre Kellermann (Analista de Sucesso do Cliente).
                    </p>
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    <p className="my-4">
                        Utilizando a ferramenta Hotjar, analisei mapas de calor de diversas telas 
                        do VC-X Sonar, para visualizar a interação dos usuários com as informações 
                        do sistema e tentar entender quais informações consideravam mais 
                ...
                <>
                    ...
                    <table className="table table-hover mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td colSpan="3">
                                    Expor uma visualização resumida com as principais informações 
                                    de cada módulo do Sonar.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul className="pl-4">
                                        <li>
                                            Módulos têm quantidades diferentes de conteúdo.
                                        </li>
                                        <li>
                                            Dificuldade em fazer com que o painel geral e os 
                                            painéis de módulos “conversem” entre si.
                                        </li>
                                        <li>
                                            Incluir dados que já existam nos painéis de cada 
                                            módulo, fazendo com que pareçam redundantes nestes 
                                            painéis.
                                        </li>
                                    </ul>
                                </td>
                                <td>
                                    <ul className="pl-4">
                                        <li>
                                            Organizar grid de maneira que a existência dos 
                                            diversos módulos seja visível já no início da 
                                            visualização.
                                        </li>
                                        <li>
                                            Dividir espaço da maneira mais igualitária possível.
                                        </li>
                                        <li>
                                            Realizar uma tarefa separada, em outro momento, para 
                                            o redesign dos painéis dos módulos tendo o painel 
                            ...
                            <tr>
                                <td>
                                    Facilitar a compreensão das mudanças das informações ao longo 
                                    de períodos de tempo maiores que um mês.
                                </td>
                                <td>
                                    Em alguns dados faz mais sentido ter visualização mensal 
                                    (ex: vencimento de faturas). Pode ser que seja difícil 
                                    compreender os controles.
                                </td>
                                <td>
                                    <ul className="pl-4">
                                        <li>
                                            Apresentar informações por default em períodos de 
                                            três meses.
                                        </li>
                                        <li>
                                            Permitir troca para 1 mês, 6 meses e 12 meses.
                                        </li>
                                    </ul>
                                </td>
                            </tr>
            ...
            content: (
                <>
                    <p className="mt-4 mb-2">
                        ...
                        aos objetivos e estratégias do projeto e organizei um protótipo no 
                        Adobe XD, para simular a interface e algumas interações básicas. O 
                        protótipo foi apresentado à equipe de desenvolvimento e a partir dos 
                        feedbacks da equipe, foi refinado.
                    </p>
                    <p className="mt-4 mb-0">
            ...
            content: (
                <>
                    <p className="my-4">
                        ...
                        ChartJs, pois consideramos ter uma boa quantidade e qualidade de gráficos 
                        disponíveis, facilidade de implementação e uma documentação mais completa 
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="mb-0 mt-4">
                        Em parceria com o desenvolvedor Gustavo Presa, implementei as requisições 
                        ajax responsáveis por coletar no banco de dados as informações que iriam 
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="mb-0 mt-4">
                        Finalizada a implementação do primeiro card, abri o Pull Request. O código 
                        foi revisado pelos desenvolvedores Hugo Santos e Gustavo Presa. Após os 
                        ajustes e aprovação, dei início a segunda tarefa, para a implementação 
                        dos demais cards.
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="my-4">
                        Em alguns dos cards as informações são mostradas em formato de tabelas. Eu 
        ...
        },
        {
            ...
            content: (
                <>
                    <p className="mb-0 mt-4">
                        A última etapa realizada foi a abertura de um Pull Request para a tarefa. 
                        O código foi revisado novamente pelos desenvolvedores Hugo Santos e 
                        Gustavo Presa. Realizados os ajustes, o Painel Geral foi publicado em 
                        homologação, para ser testado por outras equipes. Foram colhidos feedbacks 
                        e realizados pequenos ajustes antes da publicação para os usuários.
                    </p>
                </>
            ),
        },
    ...
    conclusion: (
        <>
            ...
            <p className="my-4">
                O desenvolvimento do dashboard em si, já apresentou uma complexidade considerável. 
                A ideia de dividir a implementação em duas partes, focando primeiro em um card, 
                validando a estrutura e depois replicando nos demais cards se mostrou um grande 
                acerto. Provavelmente evitamos que a revisão de código fosse muito mais longa, já 
                que diversos ajustes seriam parecidos. Dessa forma, na segunda tarefa, já 
                implementamos tendo uma estrutura pronta e com menos ajustes necessários.
            </p>
            <p className="my-4">
                Meu maior desafio nesse projeto foi o de trabalhar com duas bibliotecas que ainda 
                não conhecia, a ChartJs e a DayJs. A troca de período dos dados dos gráficos é uma 
                das funcionalidades mais importantes do dashboard, então compreender como 
                relacionar as duas bibliotecas exigiu um esforço considerável.
            </p>
            <p className="mb-0 mt-4">
                O que mais gostei neste projeto foi implementar os gráficos com ChartJs. Tenho 
                muito interesse na área de visualização de dados e já havia estudado outra 
                biblioteca, a D3. No entanto, achei o desenvolvimento com ChartJs mais simples e 
                divertido, tanto pela estrutura da biblioteca quanto pela qualidade da documentação. 
                Pretendo continuar estudando e trabalhando com ChartJs.
            </p>
        </>
    ),
};
