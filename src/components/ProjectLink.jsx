        ...
        <div className="card border-0 rounded-3 shadow-sm mb-5">
            {disabled ? (
                ...
                >
                    ...
                    <div className="card-body border-top border-3 p-0 max-h-200px overflow-hidden opacity-25">
                        <img src={imageSrc} className="w-100" alt={title} />
                    </div>
                    <div className="fst-italic position-absolute start-50 top-50 translate-middle text-purple">
                        <span className="bi bi-cone-striped fs-1 me-2"></span>
                        <span className="fs-1">Em construção...</span>
                    </div>
                </div>
            ) : (
                <Link
