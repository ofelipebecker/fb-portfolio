export const stepsData = [
    ...
    },
    {
        ...
        imagesCaptions: [
            ...
            `
                Exemplo de implementação realizada: tabelas de Ativos Vinculados e de Licenças 
                Vinculadas.
            `,
            `
                Exemplo de implementação realizada: tabela do tipo 'condensada' de Informações de 
                Fatura.
            `,
            `
                Exemplo de implementação realizada: tabela de Arquivos Aceitos para Processamento de 
                Fatura de Acordo com Operadora. Tabela do tipo 'condensada', localizada dentro de um 
                accordion do Bootstrap.
            `,
            `
                Exemplo de implementação realizada: tabela de Relatório Mensal de Processamento de 
                Faturas. Seguindo o padrão visual definido, está tabela foi implementada em MJML, 
                para ser enviada aos usuários por e-mail.
            `,
