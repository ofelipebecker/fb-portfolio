...
export const StepsContent = [
  ...
  ({ captions = '', images }) => (
    <>
      ...
      <ul className='pl-4'>
        ...
        <li className='mb-2'>
          Alinhamento: conteúdos predominantemente textuais devem ser alinhados
          à esquerda e conteúdos predominantemente numéricos devem ser alinhados
          à direita.
        </li>
        <li>Os cabeçalhos das colunas devem estar sempre visíveis.</li>
      </ul>
    </>
  ),
  ({ captions = '', images }) => (
    <>
      <p className='mt-4'>
        ...
        seguindo o mesmo padrão, porém desenvolvidas através de MJML, para envio
        por e-mail.
      </p>
  ...
  ({ captions = '', images }) => (
    <>
      <p className='my-4'>
        Para demonstrar na prática as funcionalidades implementadas, desenvolvi
        esta tabela de exemplo utilizando DataTables.js. Embora os dados sejam
        fictícios e sigam um padrão de anonimização (CNPJs e nomes gerados para
        demonstração), todas as funcionalidades de interação replicam o padrão
        estabelecido para as tabelas do VC-X Sonar.
      </p>
      <div className='mt-5'>
        <DemoTable />
      </div>
